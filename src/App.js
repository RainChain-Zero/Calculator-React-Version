...
class App extends React.Component {
        ...
        return (
            <div id="UI">
                ...
                <div className='UIForm'>
                    <p>
                        <label form="inputa" id='inputaLabel'>请输入a的值</label>
                        <input type="text" name="a" id="inputa" className="input" value={this.state.inputaValue}
    ...
    ref={(input) => {
        this.inputA = input
                        ...
                        <label form="inputb">请输入b的值</label>
                        <input type="text" name="b" id="inputb" className="input" value={this.state.inputbValue}
    onChange={this.inputbChange.bind(this)} placeholder='Only real number supported'
    ref={(input) => {
        this.inputB = input
    }}/>

                        <label form="inputc">请输入c的值</label>
                        <input type="text" name="b" id="inputb" className="input" value={this.state.inputcValue}
    ...
    ref={(input) => {
        this.inputC = input
                    ...
                    <p>
                        <label form="x1">x1</label>
                        <input type="text" name="x1" id="x1" className="input" value={this.state.x1}
    placeholder='Result x1' ref={(input) => {
    this.X1 = input
}}/>

                        <label form="x2">x2</label>
                        <input type="text" name="x2" id="x2" className="input" value={this.state.x2}
    placeholder='Result x2' ref={(input) => {
    this.X2 = input
}}/>
                    </p>
                </div>
